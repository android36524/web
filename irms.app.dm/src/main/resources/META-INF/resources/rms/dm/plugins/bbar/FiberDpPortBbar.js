...
Frame.grid.plugins.bbar.FiberDpPortBbar = Ext.extend(Object, {

	constructor : function(grid) {
		this.grid = grid;
		Frame.grid.plugins.bbar.FiberDpPortBbar.superclass.constructor.call(this);
...
//			handler : this._addPortByColumn
	...
	_batchRenamePort: function() {
		...
		var batchNamesPanel=new Frame.grid.edit.BatchNamesPanel({postfix:['号光分纤箱端子','号'],number:records.length});
