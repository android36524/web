Ext.ns('Frame.grid');
Frame.grid.DuctSegPanel = Ext.extend(Ext.Panel,{

	layout : 'border',

	constructor : function(config){

		Frame.grid.DuctSegPanel.superclass.constructor.call(this,config);
	},
	...
	initComponent : function(){
		...
		this._initView();
		Frame.grid.DuctSegPanel.superclass.initComponent.call(this);
	},
