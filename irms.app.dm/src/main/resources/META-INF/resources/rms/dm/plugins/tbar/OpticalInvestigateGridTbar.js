...
Frame.grid.plugins.tbar.OpticalInvestigateGridTbar = Ext.extend(Object,
		{
			constructor : function(grid) {
				this.grid = grid;
				Frame.grid.plugins.tbar.OpticalInvestigateGridTbar.superclass.constructor.call(this);
				return [ 
				{
					text : '区域定时任务初始化',
