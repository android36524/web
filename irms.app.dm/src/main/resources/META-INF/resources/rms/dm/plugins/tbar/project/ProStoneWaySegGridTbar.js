...
$importjs(ctx+'/rms/dm/plugins/queryform/StonewaySystemQueryPanel.js');


Frame.grid.plugins.tbar.ProStoneWaySegGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProStoneWaySegGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'StonewaySystemQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.STONEWAY_SYSTEM'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	stonewaysegGrid.fireEvent('metaloaded');
			    		    },
