...
Frame.grid.plugins.tbar.ProFiberDpGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProFiberDpGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'FiberDpQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.FIBER_DP'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	fiberDpGrid.fireEvent('metaloaded');
			    		    },
