...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/rms/dm/projectmanagement/ProjectManagement.js"></script>
		<script type="text/javascript">
			Ext.onReady(function() {
				var param = getGridCfgByCode();
				var cfg = Frame.grid.BaseGridPanel.initParamsByUrl(param);
				cfg.boName = 'ProjectManagementTemplateProxyBO';
				
				var grid = new DM.projectManagement(cfg);
