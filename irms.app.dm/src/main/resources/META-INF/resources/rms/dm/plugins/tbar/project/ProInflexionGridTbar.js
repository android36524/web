...
Frame.grid.plugins.tbar.ProInflexionGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProInflexionGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'InflexionQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.INFLEXION'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	inflexionGrid.fireEvent('metaloaded');
			    		    },
