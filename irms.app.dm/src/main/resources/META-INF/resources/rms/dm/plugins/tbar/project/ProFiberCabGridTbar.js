...
$importjs(ctx+'/rms/dm/plugins/queryform/FiberCabPanel.js');


Frame.grid.plugins.tbar.ProFiberCabGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProFiberCabGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'FiberCabQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.FIBER_CAB'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	fibercabGrid.fireEvent('metaloaded');
			    		    },
