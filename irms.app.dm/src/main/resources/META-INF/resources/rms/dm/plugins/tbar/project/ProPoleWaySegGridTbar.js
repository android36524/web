...
$importjs(ctx+'/rms/dm/plugins/queryform/PolewaySystemQueryPanel.js');


Frame.grid.plugins.tbar.ProPoleWaySegGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProPoleWaySegGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'PolewaySystemQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.POLEWAY_SYSTEM'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	polewaysegGrid.fireEvent('metaloaded');
			    		    },
