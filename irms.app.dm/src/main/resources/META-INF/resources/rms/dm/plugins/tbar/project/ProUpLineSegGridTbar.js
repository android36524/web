...
$importjs(ctx+'/rms/dm/plugins/queryform/UpLineQueryPanel.js');


Frame.grid.plugins.tbar.ProUpLineSegGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProUpLineSegGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'UpLineQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.UP_LINE'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	uplinesegGrid.fireEvent('metaloaded');
			    		    },
