...
Frame.grid.plugins.tbar.ProManhleGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProManhleGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'ManhleQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.MANHLE'
								},
					...
					_select : function(scope) {					
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	manhleGrid.fireEvent('metaloaded');
			    		    },
