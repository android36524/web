...
public class MiscRackGridTemplateProxyBO extends GridTemplateProxyBO{
	...
	public PageResult getGridData(PageQuery queryParam, GridCfg param) {
        ...
        //拼装查询条件
		String OdfSql = getMiscRackSql(param,className);
    ...
    public String getMiscRackSql(GridCfg param,String className){
    	String sql =" 1=1";
