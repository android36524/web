...
Frame.grid.edit.AccesspointAddFiberCabPanel = Ext.extend(Ext.Panel, {
	constructor : function(config) {
		Frame.grid.edit.AccesspointAddFiberCabPanel.superclass.constructor.call(this,config);
	},
	initComponent : function() {
		this._initView();
		Frame.grid.edit.AccesspointAddFiberCabPanel.superclass.initComponent.call(this);
	},
	...
	_save : function(ObjArr) {
		...
		BatchNamesAction.accessPontAddFiberCab(JsoArr,NameJson,function(data){	
			if(data){
				Ext.Msg.alert('温馨提示', '交接箱增加成功！');
			}
		});
