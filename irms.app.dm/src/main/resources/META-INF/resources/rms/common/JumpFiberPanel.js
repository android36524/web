...
IRMS.dm.JumpFiberPanel = Ext.extend(Ext.Panel,{
	...
	constructor : function(config){
		...
		IRMS.dm.JumpFiberPanel.superclass.constructor.call(this,config);
	},
	
	initComponent : function(){
		this._initItems();
		IRMS.dm.JumpFiberPanel.superclass.initComponent.call(this);
	},
	...
	importData : function() {
		...
		this.uploadForm.getForm().submit({
			scope : this,
			url : ctx + '/dm/jumpfiberimport.do?key='+this.key,
