...
Frame.grid.plugins.tbar.ProFiberJointBoxGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProFiberJointBoxGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'FiberJointBoxQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.FIBERJOINTBOX'
								},
