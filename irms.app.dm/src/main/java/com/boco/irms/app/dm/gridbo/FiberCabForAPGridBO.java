...
public class FiberCabForAPGridBO extends GridTemplateProxyBO {

	@Override
	public PageResult getGridData(PageQuery queryParam, GridCfg param) {
		String relatedAccessPoint = param.getCfgParams().get("cuid");
		// 获取列名
		...
		// 拼装查询条件
		String sql = "RELATED_SITE_CUID='" + relatedAccessPoint + "'";
