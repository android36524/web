...
Frame.grid.plugins.tbar.ProPoleGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProPoleGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function() {						
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'PoleQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.POLE'
								},
