...
Frame.grid.plugins.tbar.WireLengthStatCountyGridTbar = Ext.extend(Object, {
	constructor : function(grid) {
		this.grid = grid;
		Frame.grid.plugins.tbar.WireLengthStatCountyGridTbar.superclass.constructor.call(this);
		return [ 
			{
				text : '查看问题明细',
