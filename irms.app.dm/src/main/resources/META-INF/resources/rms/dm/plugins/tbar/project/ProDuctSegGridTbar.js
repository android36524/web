...
$importjs(ctx+'/rms/dm/plugins/queryform/DuctSystemQueryPanel.js');


Frame.grid.plugins.tbar.ProDuctSegGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProDuctSegGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'DuctSystemQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.DUCT_SYSTEM'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	ductsegGrid.fireEvent('metaloaded');
			    		    },
