...
Frame.grid.plugins.tbar.WireLengthStatGridTbar = Ext.extend(Object, {
	constructor : function(grid) {
		this.grid = grid;
		Frame.grid.plugins.tbar.WireLengthStatGridTbar.superclass.constructor.call(this);
		return [  '-',  {
							text : '查看县级结果',
	...
	_showCountyResult : function(){
		...
		var url = '/cmp_res/grid/EditorGridPanel.jsp?code=service_dict_dm.DM_WIRE_LENGTH_STAT_COUNTY&hasQuery=false';
