...
Frame.grid.edit.AccessPointAddFboxPanel = Ext.extend(Ext.Panel, {
	constructor : function(config) {
		Frame.grid.edit.AccessPointAddFboxPanel.superclass.constructor.call(this,config);
	},
	initComponent : function() {
		this._initView();
		Frame.grid.edit.AccessPointAddFboxPanel.superclass.initComponent.call(this);
	},
	...
	_save : function(ObjArr) {
		...
		BatchNamesAction.accessPontAddFiberJointBox(JsoArr,NameJson,function(data){	
			if(data){
				Ext.Msg.alert('温馨提示', '终端盒增加成功！');
			}
		});
