...
Frame.grid.plugins.tbar.ProStoneGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProStoneGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'StoneQueryPanel',
							gridCfg : {
								cfgParams : {
									templateId : 'IRMS.RMS.STONE'
								},
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	stoneGrid.fireEvent('metaloaded');
			    		    },
