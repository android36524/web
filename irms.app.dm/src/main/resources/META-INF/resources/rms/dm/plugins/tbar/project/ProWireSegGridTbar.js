...
$importjs(ctx+'/rms/dm/plugins/queryform/WireSystemQueryPanel.js');


Frame.grid.plugins.tbar.ProWireSegGridTbar = Ext
		.extend(
				Object,
				{
					constructor : function(grid) {
						this.grid = grid;
						Frame.grid.plugins.tbar.ProWireSegGridTbar.superclass.constructor
								.call(this);
						return ['-',{
							text: '添加',
					...
					_add : function(){
						var grid = new Frame.grid.MaintainGridPanel({
							hasMaintan:false,
							isTree:false,
							queryPlugin : 'WireSystemQueryPanel',
							gridCfg : {
								cfgParams : {
					...
					_select : function(scope) {
						...
						ProjectManageAction.updateRelatedProject(project,resources,{
			    		    callback: function(result){
			    		    	...
			    		    	wiresegGrid.fireEvent('metaloaded');
			    		    },
