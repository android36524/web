    ...
    items: [{
        ...
        items: [{
						...
						items:[{
										 ...
										 columns: [
											{header: "PDA编码",  sortable: true, dataIndex: 'company33'},
											{header: "用户",  sortable: true,dataIndex: 'price35'},
											{header: "设备状态",  sortable: true,dataIndex: 'price34'},
											{header: "归属设备组",  sortable: true,dataIndex: 'price33'},
											{header: "备注",  sortable: true,dataIndex: 'price32'},
											{header: "手机号码",  sortable: true,dataIndex: 'price31'}
										],
									 }]
