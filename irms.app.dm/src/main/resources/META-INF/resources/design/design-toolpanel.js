Dms.initToolPane = (function() {
	...
	return function() {
		...
		var geoLayerPanel=new tp.widget.GeoLayerPanel(map);//地理信息图层
		...
		geoTreeView=geoLayerPanel.getTreeView(),
		qPanel = queryPanel, 
...
//		panel4.setPosition(1200, 120);
		...
		document.body.appendChild(panel4.getView());
