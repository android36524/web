...
//区域细分光缆皮长统计
Frame.grid.plugins.query.DuctLineLengthStatQueryPanel = Ext.extend(Object, {
	constructor : function(grid) {
		this.grid = grid;
		Frame.grid.plugins.query.DuctLineLengthStatQueryPanel.superclass.constructor.call(this);
